export default function Hero() {
  return (
    <section className="min-h-[80vh] flex items-center justify-center px-(--spacing-section-x) pt-16">
      <div className="mw-content mx-auto w-full flex flex-col items-center text-center">
