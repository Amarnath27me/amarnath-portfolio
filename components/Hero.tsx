    ...
    <section className="min-h-[80vh] flex items-center px-(--spacing-section-x) pt-16">
      <div className="mw-content mx-auto w-full">
        <div className="max-w-[900px]">
          ...
          <h1 className="font-display ts-display lh-tight text-text-primary italic mb-4">
            Amarnath Allamraju
          </h1>

          <p className="font-mono ts-small text-text-muted tracking-wide mb-8">
            No bricks without clay.
          </p>

          <p className="font-sans ts-body-lg text-text-secondary lh-loose mw-prose mb-10">
